...
const portfolioSwaggerSchemas = {
  ...
  ExperienceCoverRequest: { type: "object", properties: { assetId: { type: "string" }, cover: { type: "string", format: "binary", description: "JPG, JPEG, PNG, or WEBP image; maximum 5 MB" } } },
  ...
  EvidenceMultipartRequest: { type: "object", required: ["type", "title"], properties: { type: { type: "string" }, title: { type: "string" }, description: { type: "string" }, url: { type: "string", format: "uri" }, file: { type: "string", format: "binary", description: "JPG, JPEG, PNG, WEBP, MP4, PDF, DOC, or DOCX; maximum 5 MB" } } },
  ...
  EvidenceUpdateMultipartRequest: { allOf: [{ $ref: "#/components/schemas/EvidenceUpdateRequest" }], properties: { file: { type: "string", format: "binary", description: "JPG, JPEG, PNG, WEBP, MP4, PDF, DOC, or DOCX; maximum 5 MB" } } },
